...
function LandlordDashboard() {
  ...
  const [isSidebarExpanded, setIsSidebarExpanded] = useState(true); // Default expanded state
        ...
        >
          <div className="card" style={styles.card}>
            <div className="card-body" style={styles.cardBody}>
              ...
              <div className="menu-item" onClick={() => handleLinkClick(<CreateApartment />)} style={styles.menuItem}>
              ...
              <div className="menu-item" onClick={() => handleLinkClick(<Category />)} style={styles.menuItem}>
                <i className="fas fa-tags" style={styles.icon}></i>
                {isSidebarExpanded && <span className="menu-text" style={styles.menuText}>CATEGORY</span>}
              </div>
              <div className="menu-item" onClick={() => handleLinkClick(<Bookings />)} style={styles.menuItem}>
                <i className="fas fa-calendar-check" style={styles.icon}></i>
                {isSidebarExpanded && <span className="menu-text" style={styles.menuText}>BOOKINGS</span>}
              </div>
              <div className="menu-item" onClick={() => handleLinkClick(<Billing />)} style={styles.menuItem}>
              ...
              <div className="menu-item" onClick={() => handleLinkClick(<Notification />)} style={styles.menuItem}>
                <i className="fas fa-bell" style={styles.icon}></i>
                {isSidebarExpanded && <span className="menu-text" style={styles.menuText}>NOTIFICATION</span>}
              </div>
